...
# years <- c(2008,2008,2010,2011,2011,2012,2013,2013,2014,2014,2015,2015,2016,2016,2017,2017,2017,2017,2018,2018,2019,2019,2019,2021,2021,2021,2021)
...
View(marvel_movies)
#ใช้ data frame เนื่องจากการนำข้อมูลมาใส่ในรูปแบบตารางทำให้ข้อมูลสะอาดและอ่านง่าย
...
sort(table(years), decreasing = TRUE)
#2017, 2021
