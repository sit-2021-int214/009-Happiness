...
View(movies)
#ใช้ data.frame เพราะการทำให้ข้อมูลอยู่ในรูปของตารางนั้นมันทำให้ข้อมูลดูง่าย และสบายตามากกว่า
-----------------------------------------------------------
#Exercise 2.2
length(names)#27
names[19]#"Avengers: Infinity War"
sort(table(years))#2017,2021

#sort(which.max(table(years)))
